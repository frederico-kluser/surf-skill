---
name: project-router
description: Project knowledge map for surf-skill — an autonomous web research tool for AI coding agents. Maps the repo structure, skills, conventions, and key files.
---

# Project Router: surf-skill

## Project Identity

**surf-skill v7.0.0** — an npm package providing an autonomous web research CLI and library for AI coding agents.

- **Type**: npm package (`surf-skill`)
- **License**: MIT
- **Runtime**: Node.js >= 18
...
| `skills/` | Sub-skills shipped with the package: `surf-plan-skill`, `surf-free-skill` |
...
| Skill | File | Purpose |
|---|---|---|
| `surf-research-skill` | `SKILL.md` (root) | Main orchestrator — multi-agent research using bursts of doubt. v7. Two modes: single-burst and continuous-burst |
| `surf-plan-skill` | `skills/surf-plan-skill/SKILL.md` | Research-grounded execution planning — writes execution plans from research findings |
| `surf-free-skill` | `skills/surf-free-skill/SKILL.md` | Free keyless search via Wikipedia + DuckDuckGo |
...
| `SKILL.md` | Main skill definition — the surf-research-skill orchestrator v7 |
